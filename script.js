window.addEventListener("load", function () {
  ...
  if (form) {
    form.addEventListener("submit", function (e) {
      ...
      if (stepSignup) stepSignup.classList.add("hidden");
      if (stepDownload) stepDownload.classList.remove("hidden");
  ...
  if (spotifyRevealBtn) {
    spotifyRevealBtn.addEventListener("click", function () {
      ...
      window.location.href = "spotify:artist:5eqThkuR9VjiLuYfzESTp7";
